-- This file contains information on how to run Project 1  - ATM By: Sara Jacobs   srjacobs@radford.edu --
* Run ATMDriver.java first *
...
Fix loop of remove bills
    do you wanna remove more
        1. yes
        2. no
    if yes
        loop back to menu
